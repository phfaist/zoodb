...
/* 000007 */ export {macrospec, FLMArgumentSpec, LatexWalkerLocatedError, ParsingStateDeltaChained, FLMParsingStateDeltaSetBlockLevel, LatexWalkerParseError, ParsedArgumentsInfo, latexnodes_parsers};
...
/* 000379 */ 				var __except0__ = __call__ (LatexWalkerParseError, null, 'Heading label ‘{}’ has incorrect prefix ‘{}:’; expected one of {}'.format (the_label, ref_type, allowed_prefixes), __kwargtrans__ ({pos: argnode.pos}));
