/* 000001 */ // Transcrypt'ed from Python, 2023-05-13 12:14:43
...
/* 000024 */ import {FLMFragment} from './flm.flmfragment.js';
/* 000019 */ import {FLMLatexWalker, FLMParsingState} from './flm.flmenvironment.js';
...
/* 000007 */ export {LatexArgumentSpec, FLMFragment, LatexContextDb, ParsedArguments, FLMParsingState, MacroSpec, LatexNodeList, FLMLatexWalker, latex_node_types, EnvironmentSpec, SpecialsSpec};
/* 000001 */ var __name__ = 'flm.flmdump';
/* 000033 */ export var fn_unique_object_id = unique_object_id.fn_unique_object_id;
/* 000042 */ export var _FakeDataLoadedFLMLatexWalker =  __class__ ('_FakeDataLoadedFLMLatexWalker', [object], {
...
/* 000067 */ export var FLMDataDumper =  __class__ ('FLMDataDumper', [object], {
...
/* 000094 */ 				return __call__ (__accu0__.startswith, __accu0__, 'flm');
/* 000094 */ 			}) ())) {
/* 000095 */ 				(function () {
...
/* 000117 */ 		}
/* 000119 */ 		if (__t__ (__call__ (isinstance, null, x, FLMLatexWalker))) {
/* 000120 */ 			return (function () {
/* 000120 */ 				var __accu0__ = self;
/* 000123 */ 				return __call__ (__accu0__._make_resource, __accu0__, 'FLMLatexWalker', x, __call__ (_FakeDataLoadedFLMLatexWalker, null, x.s), __kwargtrans__ ({dumping_state: dumping_state}));
/* 000123 */ 			}) ();
/* 000123 */ 		}
/* 000127 */ 		if (__t__ (__call__ (isinstance, null, x, FLMParsingState))) {
/* 000128 */ 			return (function () {
/* 000128 */ 				var __accu0__ = self;
/* 000128 */ 				return __call__ (__accu0__._make_resource, __accu0__, 'FLMParsingState', x, x, __kwargtrans__ ({dumping_state: dumping_state}));
/* 000128 */ 			}) ();
/* 000128 */ 		}
...
/* 000160 */ 	});}
/* 000160 */ });
/* 000166 */ export var FLMDataLoadNotSupported =  __class__ ('FLMDataLoadNotSupported', [object], {
...
/* 000175 */ 	var __iterable0__ = [FLMParsingState, ParsedArguments];
...
/* 000177 */ }) ();
/* 000183 */ export var FLMDataLoader =  __class__ ('FLMDataLoader', [object], {
...
/* 000209 */ 				return FLMDataLoadNotSupported;
/* 000209 */ 			}
...
/* 000219 */ 		if (__t__ (__eq__ (restype, 'FLMLatexWalker'))) {
/* 000220 */ 			return __call__ (_FakeDataLoadedFLMLatexWalker, null, __getitem__ (resdata, 's'));
/* 000220 */ 		}
/* 000221 */ 		if (__t__ (__eq__ (restype, 'FLMParsingState'))) {
/* 000222 */ 			return (function () {
/* 000222 */ 				var __accu0__ = self;
/* 000224 */ 				return __call__ (__accu0__._load_object, __accu0__, restype, __call__ (dict, null, resdata, __kwargtrans__ ({latex_context: FLMDataLoadNotSupported})));
/* 000224 */ 			}) ();
/* 000224 */ 		}
...
/* 000228 */ 		else {
/* 000228 */ 		}
/* 000230 */ 		if (__t__ (__eq__ (objtype, 'FLMFragment'))) {
...
/* 000253 */ 				return __call__ (__accu0__.startswith, __accu0__, 'flm');
/* 000253 */ 			}) ())) {
...
/* 000270 */ 		}) ();
/* 000271 */ 		var flm_text = (function () {
/* 000271 */ 			var __accu0__ = kwargs;
/* 000271 */ 			return __call__ (__accu0__.py_pop, __accu0__, 'flm_text');
/* 000271 */ 		}) ();
/* 000272 */ 		return __call__ (FLMFragment, null, __kwargtrans__ (__mergekwargtrans__ ({flm_text: nodelist, environment: self.environment, _flm_text_if_loading_nodes: flm_text}, kwargs)));
/* 000272 */ 	});}
/* 000272 */ });
/* 000007 */ 
