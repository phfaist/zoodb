/* 000001 */ // Transcrypt'ed from Python, 2024-09-26 17:30:23
/* 000036 */ var logging = {};
...
/* 000150 */ 		}
/* 000155 */ 		var argnlist = [];
/* 000157 */ 		var __iterable0__ = __call__ (enumerate, null, self.arguments_spec_list);
/* 000157 */ 		for (var __index0__ = 0; __index0__ < len (__iterable0__); __index0__++) {
/* 000157 */ 			var __left0__ = __getitem__ (__iterable0__, __index0__);
/* 000157 */ 			var argj = __left0__ [0];
/* 000157 */ 			var arg = __left0__ [1];
/* 000159 */ 			var arg_node_parser = arg.parser;
/* 000161 */ 			// pass;
/* 000165 */ 			var peeked_token = (function () {
/* 000165 */ 				var __accu0__ = token_reader;
/* 000165 */ 				return __call__ (__accu0__.peek_token_or_none, __accu0__, __kwargtrans__ ({parsing_state: parsing_state}));
/* 000165 */ 			}) ();
/* 000167 */ 			if (__t__ (__call__ (isinstance, null, arg_node_parser, _basestring))) {
/* 000168 */ 				var arg_node_parser = __call__ (get_standard_argument_parser, null, arg_node_parser);
/* 000168 */ 			}
/* 000170 */ 			var arg_parsing_state = __call__ (get_updated_parsing_state_from_delta, null, parsing_state, arg.parsing_state_delta, latex_walker);
/* 000176 */ 			// pass;
...
/* 000195 */ 			}) ();
/* 000195 */ 		}
/* 000197 */ 		var parsed = __call__ (ParsedArguments, null, __kwargtrans__ ({arguments_spec_list: self.arguments_spec_list, argnlist: argnlist}));
/* 000202 */ 		// pass;
/* 000206 */ 		return tuple ([parsed, null]);
/* 000206 */ 	});},
/* 000209 */ 	get __eq__ () {return __get__ (this, function (self, other) {
...
/* 000209 */ 						case 'other': var other = __allkwargs0__ [__attrib0__]; break;
/* 000209 */ 					}
/* 000209 */ 				}
/* 000209 */ 			}
/* 000209 */ 		}
/* 000209 */ 		else {
/* 000209 */ 		}
/* 000210 */ 		return __t__ (self.__class__ === other.__class__) && __eq__ (self.arguments_spec_list, other.arguments_spec_list);
/* 000210 */ 	});}
/* 000210 */ });
/* 000036 */ 
