...
/* 000036 */ export {ParsedArguments, get_updated_parsing_state_from_delta, get_standard_argument_parser, LatexParserBase, LatexArgumentSpec};
...
/* 000165 */ 			// pass;
/* 000169 */ 			var peeked_token = (function () {
/* 000169 */ 				var __accu0__ = token_reader;
/* 000169 */ 				return __call__ (__accu0__.peek_token_or_none, __accu0__, __kwargtrans__ ({parsing_state: parsing_state}));
/* 000169 */ 			}) ();
/* 000171 */ 			if (__t__ (__call__ (isinstance, null, arg_node_parser, _basestring))) {
/* 000172 */ 				var arg_node_parser = __call__ (get_standard_argument_parser, null, arg_node_parser);
/* 000172 */ 			}
/* 000174 */ 			var arg_parsing_state = __call__ (get_updated_parsing_state_from_delta, null, parsing_state, arg.parsing_state_delta, latex_walker);
/* 000180 */ 			// pass;
/* 000185 */ 			var __left0__ = (function () {
/* 000185 */ 				var __accu0__ = latex_walker;
/* 000190 */ 				return __call__ (__accu0__.parse_content, __accu0__, arg_node_parser, token_reader, arg_parsing_state, __kwargtrans__ ({open_context: tuple ([(function () {
/* 000190 */ 					var __accu1__ = 'Argument {}';
/* 000190 */ 					return __call__ (__accu1__.format, __accu1__, argj);
/* 000190 */ 				}) (), peeked_token])}));
/* 000190 */ 			}) ();
/* 000190 */ 			var argnodes = __left0__ [0];
/* 000190 */ 			var parsing_state_delta = __left0__ [1];
/* 000194 */ 			if (__t__ (parsing_state_delta !== null)) {
/* 000195 */ 				(function () {
/* 000195 */ 					var __accu0__ = logger;
/* 000195 */ 					return __call__ (__accu0__.warning, __accu0__, 'Parsing state changes information (%r) ignored in arguments!', parsing_state_delta);
/* 000195 */ 				}) ();
/* 000195 */ 			}
/* 000199 */ 			(function () {
/* 000199 */ 				var __accu0__ = argnlist;
/* 000199 */ 				return __call__ (__accu0__.append, __accu0__, argnodes);
/* 000199 */ 			}) ();
/* 000199 */ 		}
/* 000213 */ 		var parsed = __call__ (ParsedArguments, null, __kwargtrans__ ({arguments_spec_list: self.arguments_spec_list, argnlist: argnlist}));
/* 000220 */ 		// pass;
/* 000224 */ 		return tuple ([parsed, null]);
/* 000224 */ 	});},
/* 000227 */ 	get __eq__ () {return __get__ (this, function (self, other) {
...
/* 000227 */ 						case 'other': var other = __allkwargs0__ [__attrib0__]; break;
/* 000227 */ 					}
/* 000227 */ 				}
/* 000227 */ 			}
/* 000227 */ 		}
/* 000227 */ 		else {
/* 000227 */ 		}
/* 000228 */ 		return __t__ (self.__class__ === other.__class__) && __eq__ (self.arguments_spec_list, other.arguments_spec_list);
/* 000228 */ 	});}
/* 000228 */ });
/* 000036 */ 
