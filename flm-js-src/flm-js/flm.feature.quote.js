...
/* 000006 */ export {ParsedArgumentsInfo, latexnodes_nodes, ParsingStateDeltaExtendLatexContextDb, LatexWalkerLocatedError, FLMArgumentSpec, FLMEnvironmentSpecBase, MacroSpec, LatexEnvironmentBodyContentsParser, Feature, text_arg};
...
/* 000308 */ 			return false;
/* 000308 */ 		}
/* 000310 */ 		var flm_lines_setup_macro = (function () {
/* 000310 */ 			var __accu0__ = recopt_quote;
/* 000310 */ 			return __call__ (__accu0__.py_get, __accu0__, 'setup_macro', 'flmLinesSetup');
/* 000310 */ 		}) ();
...
/* 000313 */ 			return __call__ (__accu0__.py_get, __accu0__, 'attributed_macro', 'flmLinesAttributed');
/* 000313 */ 		}) ();
/* 000314 */ 		var flm_block_macro = (function () {
/* 000314 */ 			var __accu0__ = recopt_quote;
/* 000314 */ 			return __call__ (__accu0__.py_get, __accu0__, 'block_macro', 'flmLinesBlock');
/* 000314 */ 		}) ();
/* 000316 */ 		var s = __add__ (__add__ (__add__ ('\\begin{', node.environmentname), '}%'), '\n');
/* 000317 */ 		if (__t__ (__t__ (flm_lines_setup_macro !== null) && __call__ (len, null, flm_lines_setup_macro))) {
/* 000318 */ 			var s = __call__ (__iadd__, null, s, __add__ (__add__ (__add__ (__add__ (__add__ ('\\', flm_lines_setup_macro), '{'), node.environmentname), '}%'), '\n'));
/* 000318 */ 		}
...
/* 000325 */ 			var content = (function () {
/* 000325 */ 				var __accu0__ = (function () {
/* 000325 */ 					var __accu1__ = recomposer;
/* 000325 */ 					return __call__ (__accu1__.recompose_nodelist, __accu1__, text_arg_nodelist, node);
/* 000325 */ 				}) ();
/* 000325 */ 				return __call__ (__accu0__.strip, __accu0__);
/* 000325 */ 			}) ();
/* 000327 */ 			var wrap_macro = null;
/* 000328 */ 			if (__t__ (__eq__ (py_name, 'text'))) {
/* 000329 */ 				if (__t__ (__t__ (flm_text_macro !== null) && __call__ (len, null, flm_text_macro))) {
/* 000330 */ 					var wrap_macro = flm_text_macro;
/* 000330 */ 				}
/* 000330 */ 			}
/* 000331 */ 			else if (__t__ (__eq__ (py_name, 'lines'))) {
/* 000332 */ 				if (__t__ (__t__ (flm_lines_macro !== null) && __call__ (len, null, flm_lines_macro))) {
/* 000333 */ 					var wrap_macro = flm_lines_macro;
/* 000333 */ 				}
/* 000333 */ 			}
/* 000334 */ 			else if (__t__ (__eq__ (py_name, 'attributed'))) {
/* 000335 */ 				if (__t__ (__t__ (flm_attributed_macro !== null) && __call__ (len, null, flm_attributed_macro))) {
/* 000336 */ 					var wrap_macro = flm_attributed_macro;
/* 000336 */ 				}
/* 000336 */ 			}
/* 000337 */ 			else if (__t__ (__eq__ (py_name, 'block'))) {
/* 000338 */ 				if (__t__ (__t__ (flm_block_macro !== null) && __call__ (len, null, flm_block_macro))) {
/* 000339 */ 					var wrap_macro = flm_block_macro;
/* 000339 */ 				}
/* 000339 */ 			}
/* 000340 */ 			else {
/* 000341 */ 				var __except0__ = __call__ (ValueError, null, 'No idea how to render quote-section of type ‘{}’'.format (py_name));
/* 000341 */ 				__except0__.__cause__ = null;
/* 000341 */ 				throw __except0__;
/* 000341 */ 			}
/* 000345 */ 			if (__t__ (__t__ (flm_attributed_macro !== null) && __call__ (len, null, flm_attributed_macro))) {
/* 000346 */ 				var s = __call__ (__iadd__, null, s, __add__ (__add__ (__add__ (__add__ (__add__ ('\\', flm_attributed_macro), '{'), content), '}%'), '\n'));
/* 000346 */ 			}
/* 000347 */ 			else {
/* 000348 */ 				var s = __call__ (__iadd__, null, s, content);
/* 000348 */ 			}
/* 000348 */ 		}
/* 000350 */ 		var s = __call__ (__iadd__, null, s, __add__ (__add__ ('\\end{', node.environmentname), '}'));
/* 000352 */ 		return s;
/* 000352 */ 	});}
/* 000352 */ });
/* 000358 */ export var nodelist_strip_surrounding_whitespace = function (nodelist) {
...
/* 000358 */ 					case 'nodelist': var nodelist = __allkwargs0__ [__attrib0__]; break;
/* 000358 */ 				}
/* 000358 */ 			}
/* 000358 */ 		}
/* 000358 */ 	}
/* 000358 */ 	else {
/* 000358 */ 	}
/* 000359 */ 	if (__t__ (__t__ (!__t__ ((nodelist))) || !__t__ ((__call__ (len, null, nodelist))))) {
/* 000360 */ 		return nodelist;
/* 000360 */ 	}
/* 000362 */ 	var jfirst = 0;
/* 000363 */ 	var __iterable0__ = nodelist;
/* 000363 */ 	for (var __index0__ = 0; __index0__ < len (__iterable0__); __index0__++) {
/* 000363 */ 		var n = __getitem__ (__iterable0__, __index0__);
/* 000364 */ 		if (__t__ ((function () {
/* 000364 */ 			var __accu0__ = n;
/* 000364 */ 			return __call__ (__accu0__.isNodeType, __accu0__, latexnodes_nodes.LatexCommentNode);
/* 000364 */ 		}) ())) {
/* 000365 */ 			var jfirst = __call__ (__iadd__, null, jfirst, 1);
/* 000365 */ 			continue;
/* 000365 */ 		}
/* 000365 */ 		break;
/* 000365 */ 	}
/* 000369 */ 	if (__t__ (__eq__ (jfirst, __call__ (len, null, nodelist)))) {
/* 000370 */ 		return nodelist;
/* 000370 */ 	}
/* 000372 */ 	var new_node_list = (function () {
/* 000372 */ 		var __accu0__ = [];
/* 000372 */ 		var __iterable0__ = nodelist;
/* 000372 */ 		for (var __index0__ = 0; __index0__ < len (__iterable0__); __index0__++) {
/* 000373 */ 			var node = __getitem__ (__iterable0__, __index0__);
/* 000373 */ 			(function () {
/* 000373 */ 				var __accu1__ = __accu0__;
/* 000373 */ 				return __call__ (__accu1__.append, __accu1__, node);
/* 000373 */ 			}) ();
/* 000373 */ 		}
/* 000373 */ 		return __accu0__;
/* 000373 */ 	}) ();
/* 000375 */ 	var lw = nodelist.latex_walker;
/* 000377 */ 	var first_node = __getitem__ (new_node_list, jfirst);
/* 000378 */ 	if (__t__ ((function () {
/* 000378 */ 		var __accu0__ = first_node;
/* 000378 */ 		return __call__ (__accu0__.isNodeType, __accu0__, latexnodes_nodes.LatexCharsNode);
/* 000378 */ 	}) ())) {
/* 000379 */ 		if (__t__ ((function () {
/* 000379 */ 			var __accu0__ = __getitem__ (first_node.chars, 0);
/* 000379 */ 			return __call__ (__accu0__.isspace, __accu0__);
/* 000379 */ 		}) ())) {
/* 000381 */ 			var fixed_first_node = (function () {
/* 000381 */ 				var __accu0__ = lw;
/* 000383 */ 				return __call__ (__accu0__.make_node, __accu0__, latexnodes_nodes.LatexCharsNode, __kwargtrans__ ({chars: (function () {
/* 000383 */ 					var __accu1__ = first_node.chars;
/* 000383 */ 					return __call__ (__accu1__.lstrip, __accu1__);
/* 000383 */ 				}) (), pos: first_node.pos, pos_end: first_node.pos_end, parsing_state: first_node.parsing_state}));
/* 000383 */ 			}) ();
/* 000389 */ 			__setitem__ (new_node_list, jfirst, fixed_first_node);
/* 000389 */ 		}
/* 000389 */ 	}
/* 000390 */ 	else if (__t__ (__t__ (first_node.pre_space !== null) && __call__ (len, null, first_node.pre_space))) {
/* 000391 */ 		var d = dict ({});
/* 000392 */ 		var __iterable0__ = first_node._fields;
/* 000392 */ 		for (var __index0__ = 0; __index0__ < len (__iterable0__); __index0__++) {
/* 000392 */ 			var fld = __getitem__ (__iterable0__, __index0__);
/* 000393 */ 			__setitem__ (d, fld, __call__ (getattr, null, first_node, fld));
/* 000393 */ 		}
/* 000394 */ 		__setitem__ (d, 'pre_space', '');
/* 000395 */ 		var fixed_first_node = (function () {
/* 000395 */ 			var __accu0__ = lw;
/* 000395 */ 			return __call__ (__accu0__.make_node, __accu0__, first_node.__class__, __kwargtrans__ (d));
/* 000395 */ 		}) ();
/* 000400 */ 		__setitem__ (new_node_list, jfirst, fixed_first_node);
/* 000400 */ 	}
/* 000403 */ 	var jlast = __sub__ (__call__ (len, null, nodelist), 1);
/* 000404 */ 	var last_node = __getitem__ (new_node_list, jlast);
/* 000405 */ 	if (__t__ (__t__ ((function () {
/* 000405 */ 		var __accu0__ = last_node;
/* 000405 */ 		return __call__ (__accu0__.isNodeType, __accu0__, latexnodes_nodes.LatexCharsNode);
/* 000406 */ 	}) ()) && (function () {
/* 000406 */ 		var __accu0__ = __getitem__ (last_node.chars, __sub__ (__call__ (len, null, last_node.chars), 1));
/* 000406 */ 		return __call__ (__accu0__.isspace, __accu0__);
/* 000406 */ 	}) ())) {
/* 000407 */ 		var fixed_last_node = (function () {
/* 000407 */ 			var __accu0__ = lw;
/* 000409 */ 			return __call__ (__accu0__.make_node, __accu0__, latexnodes_nodes.LatexCharsNode, __kwargtrans__ ({chars: (function () {
/* 000409 */ 				var __accu1__ = last_node.chars;
/* 000409 */ 				return __call__ (__accu1__.rstrip, __accu1__);
/* 000409 */ 			}) (), pos: last_node.pos, pos_end: last_node.pos_end, parsing_state: last_node.parsing_state}));
/* 000409 */ 		}) ();
/* 000415 */ 		__setitem__ (new_node_list, jlast, fixed_last_node);
/* 000415 */ 	}
/* 000417 */ 	return (function () {
/* 000417 */ 		var __accu0__ = lw;
/* 000417 */ 		return __call__ (__accu0__.make_nodelist, __accu0__, new_node_list, __kwargtrans__ ({parsing_state: nodelist.parsing_state}));
/* 000417 */ 	}) ();
/* 000417 */ };
/* 000421 */ export var default_quote_environments = dict ({'quote': dict ({'enabled_quote_sections': ['text', 'lines', 'attributed', 'block']}), 'address': dict ({'enabled_quote_sections': [], 'auto_quote_section_bare_content': 'lines', 'content_is_block_level': false}), 'blockquote': dict ({'enabled_quote_sections': [], 'auto_quote_section_bare_content': 'block'})});
/* 000439 */ export var FeatureQuote =  __class__ ('FeatureQuote', [Feature], {
/* 000439 */ 	__module__: __name__,
/* 000441 */ 	feature_name: 'quotation',
/* 000442 */ 	feature_title: "Quote other people's words, with attribution",
/* 000445 */ 	feature_flm_doc: '\n    Provides the \\verbcode+\\begin{quote} ... \\end{quote}+ environment to produce\n    block literary quotations.\n    ',
/* 000452 */ 	DocumentManager: null,
/* 000453 */ 	RenderManager: null,
/* 000455 */ 	get __init__ () {return __get__ (this, function (self, quote_environments) {
/* 000455 */ 		if (typeof quote_environments == 'undefined' || (quote_environments != null && quote_environments.hasOwnProperty ("__kwargtrans__"))) {;
/* 000455 */ 			var quote_environments = null;
/* 000455 */ 		};
...
/* 000455 */ 						case 'quote_environments': var quote_environments = __allkwargs0__ [__attrib0__]; break;
/* 000455 */ 					}
/* 000455 */ 				}
/* 000455 */ 			}
/* 000455 */ 		}
/* 000455 */ 		else {
/* 000455 */ 		}
/* 000456 */ 		__call__ (__call__ (__super__, null, FeatureQuote, '__init__'), null, self);
/* 000457 */ 		if (__t__ (quote_environments === null)) {
/* 000458 */ 			var quote_environments = default_quote_environments;
/* 000458 */ 		}
/* 000459 */ 		self.quote_environments = quote_environments;
/* 000459 */ 	});},
/* 000462 */ 	get _mk_quote_environment_spec () {return __get__ (this, function (self, qenvname, qenvspec) {
...
/* 000462 */ 						case 'qenvname': var qenvname = __allkwargs0__ [__attrib0__]; break;
/* 000462 */ 						case 'qenvspec': var qenvspec = __allkwargs0__ [__attrib0__]; break;
/* 000462 */ 					}
/* 000462 */ 				}
/* 000462 */ 			}
/* 000462 */ 		}
/* 000462 */ 		else {
/* 000462 */ 		}
/* 000463 */ 		if (__t__ (__call__ (isinstance, null, qenvspec, QuoteEnvironment))) {
/* 000464 */ 			if (__t__ (__ne__ (qenvname, qenvspec.environmentname))) {
/* 000468 */ 				var __except0__ = __call__ (ValueError, null, 'Misconfigured QuoteEnvironment instance with qenvname != qenvspec.environmentname : {} != {}'.format (__call__ (repr, null, qenvname), __call__ (repr, null, qenvspec.environmentname)));
/* 000468 */ 				__except0__.__cause__ = null;
/* 000468 */ 				throw __except0__;
/* 000468 */ 			}
/* 000470 */ 			return qenvspec;
/* 000470 */ 		}
/* 000471 */ 		return __call__ (QuoteEnvironment, null, __kwargtrans__ (__mergekwargtrans__ ({environmentname: qenvname}, qenvspec)));
/* 000471 */ 	});},
/* 000473 */ 	get add_latex_context_definitions () {return __get__ (this, function (self) {
...
/* 000473 */ 		else {
/* 000473 */ 		}
/* 000475 */ 		var environments = (function () {
/* 000475 */ 			var __accu0__ = [];
/* 000477 */ 			var __iterable0__ = (function () {
/* 000477 */ 				var __accu1__ = self.quote_environments;
...
/* 000477 */ 				var qenvname = __left0__ [0];
/* 000477 */ 				var qenvspec = __left0__ [1];
/* 000477 */ 				(function () {
/* 000477 */ 					var __accu1__ = __accu0__;
/* 000476 */ 					return __call__ (__accu1__.append, __accu1__, (function () {
/* 000476 */ 						var __accu2__ = self;
/* 000476 */ 						return __call__ (__accu2__._mk_quote_environment_spec, __accu2__, qenvname, qenvspec);
/* 000476 */ 					}) ());
/* 000476 */ 				}) ();
/* 000476 */ 			}
/* 000476 */ 			return __accu0__;
/* 000476 */ 		}) ();
/* 000480 */ 		return dict ({'environments': environments});
/* 000480 */ 	});}
/* 000480 */ });
/* 000487 */ export var FeatureClass = FeatureQuote;
/* 000006 */ 
