...
/* 000007 */ export {FLMArgumentSpec, LatexEnvironmentBodyContentsParser, FLMEnvironmentSpecBase, LatexWalkerLocatedError, MacroSpec, ParsingStateDeltaEnterMathMode, ParsedArgumentsInfo, build_counter_formatter, latexnodes_parsers, Counter, Feature, latexnodes_nodes, FLMMacroSpecBase, ParsingStateDeltaExtendLatexContextDb};
...
/* 000528 */ 					return __call__ (__accu0__.make_safe_label, __accu0__, 'ref', ref_type, ref_label);
/* 000528 */ 				}) ();
/* 000529 */ 				var s_line = __call__ (__iadd__, null, s_line, __add__ (__add__ ('\\label{', __getitem__ (safe_label_info, 'safe_label')), '}'));
/* 000529 */ 			}
/* 000531 */ 			if (__t__ (__getitem__ (line_infos, 'nonumber'))) {
/* 000532 */ 				var s_line = __call__ (__iadd__, null, s_line, '\\nonumber ');
/* 000532 */ 			}
/* 000534 */ 			if (__t__ (__getitem__ (line_infos, 'newline_node'))) {
/* 000535 */ 				var s_line = __call__ (__iadd__, null, s_line, (function () {
/* 000535 */ 					var __accu0__ = recomposer;
/* 000535 */ 					return __call__ (__accu0__.subrecompose, __accu0__, __getitem__ (line_infos, 'newline_node'));
/* 000535 */ 				}) ());
/* 000535 */ 			}
/* 000542 */ 			var final_newlines = __getitem__ (edge_newlines_info, 'final');
/* 000543 */ 			var s_line = __call__ (__iadd__, null, s_line, final_newlines);
/* 000545 */ 			// pass;
/* 000549 */ 			(function () {
/* 000549 */ 				var __accu0__ = s_lines;
/* 000549 */ 				return __call__ (__accu0__.append, __accu0__, s_line);
/* 000549 */ 			}) ();
/* 000550 */ 			var last_line_already_has_newline = (__t__ (__call__ (len, null, final_newlines)) ? true : false);
/* 000550 */ 		}
/* 000552 */ 		var s = __call__ (__iadd__, null, s, (function () {
/* 000552 */ 			var __accu0__ = '';
/* 000552 */ 			return __call__ (__accu0__.join, __accu0__, s_lines);
/* 000552 */ 		}) ());
/* 000554 */ 		var s = __call__ (__iadd__, null, s, __add__ (__add__ ('\\end{', node.environmentname), '}'));
/* 000556 */ 		return s;
/* 000556 */ 	});}
/* 000556 */ });
/* 000559 */ export var _rx_newline_spaces = (function () {
/* 000559 */ 	var __accu0__ = re;
/* 000559 */ 	return __call__ (__accu0__.compile, __accu0__, '([ \\t]*?\\n)+(?P<indent>[ \\t]*)');
/* 000559 */ }) ();
/* 000563 */ export var MathEqrefMacro =  __class__ ('MathEqrefMacro', [FLMMacroSpecBase], {
/* 000563 */ 	__module__: __name__,
/* 000565 */ 	delayed_render: true,
/* 000567 */ 	allowed_in_standalone_mode: false,
/* 000572 */ 	get __init__ () {return __get__ (this, function (self, macroname, ref_type) {
/* 000572 */ 		if (typeof macroname == 'undefined' || (macroname != null && macroname.hasOwnProperty ("__kwargtrans__"))) {;
/* 000572 */ 			var macroname = 'eqref';
/* 000572 */ 		};
/* 000572 */ 		if (typeof ref_type == 'undefined' || (ref_type != null && ref_type.hasOwnProperty ("__kwargtrans__"))) {;
/* 000572 */ 			var ref_type = 'eq';
/* 000572 */ 		};
/* 000572 */ 		var kwargs = dict ();
...
/* 000572 */ 						case 'macroname': var macroname = __allkwargs0__ [__attrib0__]; break;
/* 000572 */ 						case 'ref_type': var ref_type = __allkwargs0__ [__attrib0__]; break;
/* 000572 */ 						default: kwargs [__attrib0__] = __allkwargs0__ [__attrib0__];
/* 000572 */ 					}
/* 000572 */ 				}
/* 000572 */ 				delete kwargs.__kwargtrans__;
/* 000572 */ 			}
/* 000572 */ 		}
/* 000572 */ 		else {
/* 000572 */ 		}
/* 000577 */ 		__call__ (__call__ (__super__, null, MathEqrefMacro, '__init__'), null, self, __kwargtrans__ ({macroname: macroname, arguments_spec_list: [__call__ (FLMArgumentSpec, null, (function () {
/* 000577 */ 			var __accu0__ = latexnodes_parsers;
/* 000577 */ 			return __call__ (__accu0__.LatexCharsGroupParser, __accu0__);
/* 000577 */ 		}) (), __kwargtrans__ ({argname: 'ref_label', flm_doc: __add__ (__add__ ('Equation label.  Must begin with the prefix ‘\\verbtext+', ref_type), ':+’')}))]}));
/* 000584 */ 		self.ref_type = ref_type;
/* 000584 */ 	});},
/* 000586 */ 	_fields: tuple (['macroname', 'ref_type']),
/* 000588 */ 	get get_flm_doc () {return __get__ (this, function (self) {
...
/* 000588 */ 		else {
/* 000588 */ 		}
/* 000589 */ 		return __add__ (__add__ ('Refer to an equation by its label.  The argument must be\n            a valid equation label which starts with \\verbcode+', self.ref_type), ':+.  You can place labels in display equations using the\n            \\verbcode+\\label{…}+ macro.');
/* 000589 */ 	});},
/* 000596 */ 	get postprocess_parsed_node () {return __get__ (this, function (self, node) {
...
/* 000596 */ 						case 'node': var node = __allkwargs0__ [__attrib0__]; break;
/* 000596 */ 					}
/* 000596 */ 				}
/* 000596 */ 			}
/* 000596 */ 		}
/* 000596 */ 		else {
/* 000596 */ 		}
/* 000598 */ 		var node_args = (function () {
/* 000598 */ 			var __accu0__ = __call__ (ParsedArgumentsInfo, null, __kwargtrans__ ({node: node}));
/* 000598 */ 			return __call__ (__accu0__.get_all_arguments_info, __accu0__, tuple (['ref_label']));
/* 000598 */ 		}) ();
/* 000602 */ 		var ref_type = null;
/* 000603 */ 		var ref_label = (function () {
/* 000603 */ 			var __accu0__ = __getitem__ (node_args, 'ref_label');
/* 000603 */ 			return __call__ (__accu0__.get_content_as_chars, __accu0__);
/* 000603 */ 		}) ();
/* 000604 */ 		if (__t__ (__in__ (':', ref_label))) {
/* 000605 */ 			var __left0__ = (function () {
/* 000605 */ 				var __accu0__ = ref_label;
/* 000605 */ 				return __call__ (__accu0__.py_split, __accu0__, ':', 1);
/* 000605 */ 			}) ();
/* 000605 */ 			var ref_type = __left0__ [0];
/* 000605 */ 			var ref_label = __left0__ [1];
/* 000605 */ 		}
/* 000607 */ 		if (__t__ (__ne__ (ref_type, self.ref_type))) {
/* 000608 */ 			var __except0__ = __call__ (LatexWalkerLocatedError, null, 'Equation labels must begin with “{}:” (error in ‘\\{}’)'.format (self.ref_type, node.macroname), __kwargtrans__ ({pos: node.pos}));
/* 000608 */ 			__except0__.__cause__ = null;
/* 000608 */ 			throw __except0__;
/* 000608 */ 		}
/* 000614 */ 		node.flmarg_ref = tuple ([ref_type, ref_label]);
/* 000615 */ 		node.flm_ref_info = dict ({'ref_list': [node.flmarg_ref], 'display_content_nodelist': null});
/* 000615 */ 	});},
/* 000621 */ 	get prepare_delayed_render () {return __get__ (this, function (self, node, render_context) {
...
/* 000621 */ 						case 'node': var node = __allkwargs0__ [__attrib0__]; break;
/* 000621 */ 						case 'render_context': var render_context = __allkwargs0__ [__attrib0__]; break;
/* 000621 */ 					}
/* 000621 */ 				}
/* 000621 */ 			}
/* 000621 */ 		}
...
/* 000622 */ 		// pass;
/* 000622 */ 	});},
/* 000624 */ 	get render () {return __get__ (this, function (self, node, render_context) {
...
/* 000624 */ 						case 'node': var node = __allkwargs0__ [__attrib0__]; break;
...
/* 000624 */ 		else {
/* 000624 */ 		}
/* 000626 */ 		var __left0__ = node.flmarg_ref;
/* 000626 */ 		var ref_type = __left0__ [0];
/* 000626 */ 		var ref_label = __left0__ [1];
/* 000628 */ 		var refs_mgr = (function () {
/* 000628 */ 			var __accu0__ = render_context;
/* 000628 */ 			return __call__ (__accu0__.feature_render_manager, __accu0__, 'refs');
/* 000628 */ 		}) ();
/* 000630 */ 		var resource_info = node.latex_walker.resource_info;
/* 000632 */ 		try {
/* 000633 */ 			return (function () {
/* 000633 */ 				var __accu0__ = refs_mgr;
/* 000633 */ 				return __call__ (__accu0__.render_ref, __accu0__, ref_type, ref_label, null, resource_info, __kwargtrans__ ({counter_with_prefix: false}));
/* 000633 */ 			}) ();
/* 000633 */ 		}
/* 000633 */ 		catch (__except0__) {
/* 000633 */ 			if (isinstance (__except0__, Exception)) {
/* 000633 */ 				var e = __except0__;
/* 000640 */ 				(function () {
/* 000640 */ 					var __accu0__ = logger;
/* 000641 */ 					return __call__ (__accu0__.error, __accu0__, 'Failed to resolve reference to ‘{}:{}’: {} in ‘{}’ @ {}'.format (ref_type, ref_label, e, (function () {
/* 000641 */ 						var __accu1__ = node;
/* 000641 */ 						return __call__ (__accu1__.latex_verbatim, __accu1__);
/* 000641 */ 					}) (), (function () {
/* 000641 */ 						var __accu1__ = node;
/* 000641 */ 						return __call__ (__accu1__.format_pos, __accu1__);
/* 000641 */ 					}) ()));
/* 000641 */ 				}) ();
/* 000642 */ 				var __except1__ = __call__ (LatexWalkerLocatedError, null, 'Unable to resolve reference to ‘{}:{}’. {}'.format (ref_type, ref_label, e), __kwargtrans__ ({pos: node.pos}));
/* 000642 */ 				__except1__.__cause__ = null;
/* 000642 */ 				throw __except1__;
/* 000642 */ 			}
/* 000642 */ 			else {
/* 000642 */ 				throw __except0__;
/* 000642 */ 			}
/* 000642 */ 		}
/* 000642 */ 	});},
/* 000647 */ 	get recompose_pure_latex () {return __get__ (this, function (self, node, recomposer) {
...
/* 000647 */ 						case 'node': var node = __allkwargs0__ [__attrib0__]; break;
/* 000647 */ 						case 'recomposer': var recomposer = __allkwargs0__ [__attrib0__]; break;
/* 000647 */ 					}
/* 000647 */ 				}
/* 000647 */ 			}
/* 000647 */ 		}
/* 000647 */ 		else {
/* 000647 */ 		}
/* 000649 */ 		var safe_label_info = (function () {
/* 000649 */ 			var __accu0__ = recomposer;
/* 000649 */ 			return __call__ (__accu0__.make_safe_label, __accu0__, 'ref', __getitem__ (node.flmarg_ref, 0), __getitem__ (node.flmarg_ref, 1));
/* 000649 */ 		}) ();
/* 000653 */ 		return __add__ (__add__ ('\\eqref{', __getitem__ (safe_label_info, 'safe_label')), '}');
/* 000653 */ 	});}
/* 000653 */ });
/* 000658 */ export var FeatureClass = FeatureMath;
/* 000007 */ 
