...
/* 000007 */ export {latexnodes_parsers, FLMSpecInfo, SimpleLatexDefinitionsFeature, FLMArgumentSpec, ParsedArgumentsInfo, latexnodes_nodes, macrospec};
...
/* 000149 */ 			return __call__ (__accu0__.append, __accu0__, __call__ (FLMArgumentSpec, null, __kwargtrans__ ({parser: (function () {
...
/* 000149 */ 			}) (), argname: 'verbatim_lang', flm_doc: 'Programming language in which to interpret the verbatim content, if applicable.  Some formatters might support syntax highlighting in the relevant language.'})));
/* 000149 */ 		}) ();
/* 000149 */ 	}
/* 000162 */ 	if (__t__ (ismacro)) {
/* 000163 */ 		(function () {
/* 000163 */ 			var __accu0__ = a;
/* 000165 */ 			return __call__ (__accu0__.append, __accu0__, __call__ (FLMArgumentSpec, null, __kwargtrans__ ({parser: (function () {
...
/* 000165 */ 			}) (), argname: 'verbatim_content', flm_doc: 'The raw, verbatim content to typeset.  Any special characters, including \\verbcode+\\+, \\verbcode+{+, and \\verbcode+}+, will be typeset as is.'})));
/* 000165 */ 		}) ();
/* 000165 */ 	}
/* 000174 */ 	return a;
/* 000174 */ };
...
/* 000216 */ 	get feature_flm_doc () {return __get__ (this, function (self) {
