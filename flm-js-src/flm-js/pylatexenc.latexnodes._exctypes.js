/* 000001 */ // Transcrypt'ed from Python, 2025-10-21 17:57:19
/* 000037 */ var logging = {};
...
/* 000266 */ 			}) ();
/* 000266 */ 		}
/* 000267 */ 		if (__t__ (__call__ (isinstance, null, lineno, _basestring))) {
/* 000268 */ 			return __add__ ('@ ', lineno);
/* 000268 */ 		}
/* 000269 */ 		return (function () {
/* 000269 */ 			var __accu0__ = '@ line {}';
/* 000269 */ 			return __call__ (__accu0__.format, __accu0__, lineno);
/* 000269 */ 		}) ();
/* 000269 */ 	}
/* 000270 */ 	if (__t__ (__call__ (isinstance, null, pos, _basestring))) {
/* 000271 */ 		return __add__ ('@ ', pos);
/* 000271 */ 	}
/* 000272 */ 	if (__t__ (pos !== null)) {
/* 000273 */ 		return (function () {
/* 000273 */ 			var __accu0__ = '@ char pos {}';
/* 000273 */ 			return __call__ (__accu0__.format, __accu0__, pos);
/* 000273 */ 		}) ();
/* 000273 */ 	}
/* 000274 */ 	return '@ <unknown>';
/* 000274 */ };
/* 000279 */ export var LatexWalkerTokenParseError =  __class__ ('LatexWalkerTokenParseError', [LatexWalkerParseError], {
/* 000279 */ 	__module__: __name__,
/* 000303 */ 	get __init__ () {return __get__ (this, function (self, recovery_token_placeholder, recovery_token_at_pos) {
/* 000303 */ 		var kwargs = dict ();
...
/* 000303 */ 						case 'recovery_token_placeholder': var recovery_token_placeholder = __allkwargs0__ [__attrib0__]; break;
/* 000303 */ 						case 'recovery_token_at_pos': var recovery_token_at_pos = __allkwargs0__ [__attrib0__]; break;
/* 000303 */ 						default: kwargs [__attrib0__] = __allkwargs0__ [__attrib0__];
/* 000303 */ 					}
/* 000303 */ 				}
/* 000303 */ 				delete kwargs.__kwargtrans__;
/* 000303 */ 			}
/* 000303 */ 		}
/* 000303 */ 		else {
/* 000303 */ 		}
/* 000304 */ 		__call__ (__call__ (__super__, null, LatexWalkerTokenParseError, '__init__'), null, self, __kwargtrans__ (kwargs));
/* 000305 */ 		self.recovery_token_placeholder = recovery_token_placeholder;
/* 000306 */ 		self.recovery_token_at_pos = recovery_token_at_pos;
/* 000306 */ 	});}
/* 000306 */ });
/* 000309 */ export var LatexWalkerNodesParseError =  __class__ ('LatexWalkerNodesParseError', [LatexWalkerParseError], {
/* 000309 */ 	__module__: __name__,
/* 000349 */ 	get __init__ () {return __get__ (this, function (self, recovery_nodes, recovery_parsing_state_delta, recovery_at_token, recovery_past_token) {
/* 000349 */ 		if (typeof recovery_nodes == 'undefined' || (recovery_nodes != null && recovery_nodes.hasOwnProperty ("__kwargtrans__"))) {;
/* 000349 */ 			var recovery_nodes = null;
/* 000349 */ 		};
/* 000349 */ 		if (typeof recovery_parsing_state_delta == 'undefined' || (recovery_parsing_state_delta != null && recovery_parsing_state_delta.hasOwnProperty ("__kwargtrans__"))) {;
/* 000349 */ 			var recovery_parsing_state_delta = null;
/* 000349 */ 		};
/* 000349 */ 		if (typeof recovery_at_token == 'undefined' || (recovery_at_token != null && recovery_at_token.hasOwnProperty ("__kwargtrans__"))) {;
/* 000349 */ 			var recovery_at_token = null;
/* 000349 */ 		};
/* 000349 */ 		if (typeof recovery_past_token == 'undefined' || (recovery_past_token != null && recovery_past_token.hasOwnProperty ("__kwargtrans__"))) {;
/* 000349 */ 			var recovery_past_token = null;
/* 000349 */ 		};
...
/* 000349 */ 						case 'recovery_nodes': var recovery_nodes = __allkwargs0__ [__attrib0__]; break;
/* 000349 */ 						case 'recovery_parsing_state_delta': var recovery_parsing_state_delta = __allkwargs0__ [__attrib0__]; break;
/* 000349 */ 						case 'recovery_at_token': var recovery_at_token = __allkwargs0__ [__attrib0__]; break;
/* 000349 */ 						case 'recovery_past_token': var recovery_past_token = __allkwargs0__ [__attrib0__]; break;
...
/* 000349 */ 		else {
/* 000349 */ 		}
/* 000355 */ 		__call__ (__call__ (__super__, null, LatexWalkerNodesParseError, '__init__'), null, self, __kwargtrans__ (kwargs));
/* 000356 */ 		self.recovery_nodes = recovery_nodes;
/* 000357 */ 		self.recovery_parsing_state_delta = recovery_parsing_state_delta;
/* 000358 */ 		self.recovery_at_token = recovery_at_token;
/* 000359 */ 		self.recovery_past_token = recovery_past_token;
/* 000359 */ 	});}
/* 000359 */ });
/* 000364 */ export var LatexWalkerEndOfStream =  __class__ ('LatexWalkerEndOfStream', [LatexWalkerError], {
/* 000364 */ 	__module__: __name__,
/* 000377 */ 	get __init__ () {return __get__ (this, function (self, final_space) {
/* 000377 */ 		if (typeof final_space == 'undefined' || (final_space != null && final_space.hasOwnProperty ("__kwargtrans__"))) {;
/* 000377 */ 			var final_space = '';
/* 000377 */ 		};
...
/* 000377 */ 						case 'final_space': var final_space = __allkwargs0__ [__attrib0__]; break;
/* 000377 */ 					}
/* 000377 */ 				}
/* 000377 */ 			}
/* 000377 */ 		}
/* 000377 */ 		else {
/* 000377 */ 		}
/* 000378 */ 		__call__ (__call__ (__super__, null, LatexWalkerEndOfStream, '__init__'), null, self);
/* 000379 */ 		self.final_space = final_space;
/* 000379 */ 	});}
/* 000379 */ });
/* 000037 */ 
