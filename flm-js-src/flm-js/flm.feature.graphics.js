...
/* 000006 */ export {FLMArgumentSpec, ParsedArgumentsInfo, latexnodes_parsers, Feature, FLMMacroSpecBase, LatexWalkerLocatedError};
...
/* 000044 */ 	});}
/* 000044 */ });
/* 000054 */ export var SimpleIncludeGraphicsMacro =  __class__ ('SimpleIncludeGraphicsMacro', [FLMMacroSpecBase], {
...
/* 000064 */ 		else {
/* 000064 */ 		}
/* 000069 */ 		__call__ (__call__ (__super__, null, SimpleIncludeGraphicsMacro, '__init__'), null, self, __kwargtrans__ (__mergekwargtrans__ ({macroname: 'includegraphics', arguments_spec_list: [__call__ (FLMArgumentSpec, null, __kwargtrans__ ({parser: (function () {
...
/* 000076 */ 		}) (), argname: 'graphics_options'})), __call__ (FLMArgumentSpec, null, __kwargtrans__ ({parser: (function () {
