...
HTML Documentation with API reference: in `doc/_build/html/index.html` and linked files.  HTML documentation is generated by calling `cd doc && poetry run make html`.
