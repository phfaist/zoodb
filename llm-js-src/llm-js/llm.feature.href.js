...
/* 000013 */ import {LLMArgumentSpec, LLMMacroSpecBase} from './llm.llmspecinfo.js';
...
/* 000006 */ export {LLMArgumentSpec, SimpleLatexDefinitionsFeature, latexnodes_nodes, latexnodes_parsers, ParsedArgumentsInfo, LLMMacroSpecBase};
/* 000001 */ var __name__ = 'llm.feature.href';
/* 000007 */ export var logger = (function () {
/* 000007 */ 	var __accu0__ = logging;
/* 000007 */ 	return __call__ (__accu0__.getLogger, __accu0__, __name__);
/* 000007 */ }) ();
/* 000020 */ export var _href_arg_specs = dict ({'target_href': __call__ (LLMArgumentSpec, null, __kwargtrans__ ({parser: (function () {
/* 000020 */ 	var __accu0__ = latexnodes_parsers;
/* 000020 */ 	return __call__ (__accu0__.LatexDelimitedVerbatimParser, __accu0__, tuple (['{', '}']));
/* 000024 */ }) (), argname: 'target_href'})), 'target_email': __call__ (LLMArgumentSpec, null, __kwargtrans__ ({parser: (function () {
/* 000024 */ 	var __accu0__ = latexnodes_parsers;
/* 000024 */ 	return __call__ (__accu0__.LatexDelimitedVerbatimParser, __accu0__, tuple (['{', '}']));
/* 000027 */ }) (), argname: 'target_email'})), 'display_text': __call__ (LLMArgumentSpec, null, __kwargtrans__ ({parser: '{', argname: 'display_text'}))});
/* 000034 */ export var HrefHyperlinkMacro =  __class__ ('HrefHyperlinkMacro', [LLMMacroSpecBase], {
...
/* 000055 */ 			self._llm_main_text_argument = 'display_text';
/* 000055 */ 		}
/* 000055 */ 	});},
...
/* 000087 */ 		}
/* 000088 */ 		else {
/* 000089 */ 			var __except0__ = __call__ (ValueError, null, 'LLM Internal Error: no URL or hyper reference provided to href-like macro');
...
/* 000094 */ 			}) ();
/* 000094 */ 		}
/* 000096 */ 		node.llm_href_info = dict ({'target_href': target_href, 'display_text_nodelist': display_text_nodelist});
/* 000096 */ 	});},
...
/* 000101 */ 		else {
/* 000101 */ 		}
/* 000103 */ 		var target_href = __getitem__ (node.llm_href_info, 'target_href');
/* 000104 */ 		var display_text_nodelist = __getitem__ (node.llm_href_info, 'display_text_nodelist');
...
/* 000006 */ 
//# sourceMappingURL=llm.feature.href.map