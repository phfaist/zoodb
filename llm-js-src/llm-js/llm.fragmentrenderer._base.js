...
/* 000359 */ 	});},
/* 000361 */ 	get render_cells () {return __get__ (this, function (self, cells_model, render_context, target_id) {
/* 000361 */ 		if (typeof target_id == 'undefined' || (target_id != null && target_id.hasOwnProperty ("__kwargtrans__"))) {;
...
/* 000361 */ 						case 'cells_model': var cells_model = __allkwargs0__ [__attrib0__]; break;
...
/* 000361 */ 		else {
/* 000361 */ 		}
/* 000362 */ 		var __except0__ = __call__ (RuntimeError, null, 'Feature is not implemented by subclass');
/* 000362 */ 		__except0__.__cause__ = null;
/* 000362 */ 		throw __except0__;
/* 000362 */ 	});},
/* 000369 */ 	get _ensure_render_context () {return __get__ (this, function (self, render_context) {
...
/* 000369 */ 		else {
/* 000369 */ 		}
/* 000370 */ 		return __t__ (render_context) || __call__ (LLMRenderContext, null, __kwargtrans__ ({fragment_renderer: self}));
/* 000370 */ 	});}
/* 000370 */ });
/* 000007 */ 
