...
/* 000006 */ export {latexnodes_parsers, Feature, EndnoteCategory, LLMArgumentSpec, macrospec, latexnodes_nodes, build_counter_formatter, ParsedArgumentsInfo, LLMMacroSpecBase, LLMFragment};
...
/* 000095 */ 					return __call__ (__accu0__.make_standalone_fragment, __accu0__, citation_llm_text, __kwargtrans__ ({is_block_level: false, what: 'Citation text for {}:{}'.format (cite_prefix, cite_key)}));
/* 000095 */ 				}) ();
/* 000095 */ 			}
/* 000103 */ 			return citation_llm;
/* 000103 */ 		});},
...
/* 000132 */ 					return __call__ (__accu1__.format_llm, __accu1__, endnote.number, __kwargtrans__ ({with_delimiters: false}));
...
/* 000229 */ 				var citation_content_llm = null;
/* 000230 */ 				var show_inline_content_llm = null;
/* 000231 */ 				if (__t__ (self.use_endnotes)) {
/* 000232 */ 					var show_inline_content_llm = endnote.formatted_inner_counter_value_llm;
/* 000232 */ 				}
/* 000233 */ 				else {
/* 000234 */ 					var citation_content_llm = (function () {
/* 000234 */ 						var __accu0__ = self;
/* 000234 */ 						return __call__ (__accu0__.get_citation_content_llm, __accu0__, citation_key_prefix, citation_key, resource_info);
/* 000234 */ 					}) ();
/* 000239 */ 					var show_inline_content_llm = citation_content_llm;
/* 000239 */ 				}
...
/* 000259 */ 					return __call__ (__accu0__.extend, __accu0__, __call__ (list, null, show_inline_content_llm.nodes));
/* 000259 */ 				}) ();
...
/* 000373 */ 	});}
/* 000373 */ });
/* 000386 */ export var cite_macro_arguments = [__call__ (LLMArgumentSpec, null, '[', __kwargtrans__ ({argname: 'cite_pre_text'})), __call__ (LLMArgumentSpec, null, (function () {
...
/* 000414 */ 	});}
/* 000414 */ });
/* 000418 */ export var CiteMacro =  __class__ ('CiteMacro', [LLMMacroSpecBase], {
...
/* 000422 */ 		else {
/* 000422 */ 		}
/* 000425 */ 		var arguments_spec_list = __add__ (__add__ ([], cite_macro_arguments), [__call__ (LLMArgumentSpec, null, __kwargtrans__ ({parser: __call__ (TackOnMultipleCiteCommandsMacroParser, null, ['cite']), argname: 'cite_more', llm_doc: 'An immediately following \\verbcode+\\cite{…}+ macro call gets appended to the current batch of citations'}))]);
...
/* 000535 */ 			}
/* 000535 */ 		}
/* 000538 */ 		node.llmarg_cite_items = cite_items;
/* 000540 */ 		return node;
/* 000540 */ 	});},
...
/* 000547 */ 			return __call__ (__accu0__.render_citation_marks, __accu0__, node.llmarg_cite_items, node);
/* 000547 */ 		}) ();
/* 000547 */ 	});}
/* 000547 */ });
/* 000006 */ 
