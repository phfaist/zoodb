...
/* 000006 */ export {LLMArgumentSpec, latexnodes_nodes, LLMEnvironmentSpecBase, TextFormatMacro, Feature, llmspecinfo, ParsedArguments, refs, ParsedArgumentsInfo, LLMMacroSpecBase, LLMParsingStateDeltaSetBlockLevel};
...
/* 000036 */ 	}) ());
/* 000036 */ };
/* 000042 */ export var DefineTermEnvironment =  __class__ ('DefineTermEnvironment', [LLMEnvironmentSpecBase], {
...
/* 000052 */ 		else {
/* 000052 */ 		}
/* 000061 */ 		__call__ (__call__ (__super__, null, DefineTermEnvironment, '__init__'), null, self, __kwargtrans__ (__mergekwargtrans__ ({environmentname: environmentname, arguments_spec_list: [__call__ (LLMArgumentSpec, null, '{', __kwargtrans__ ({argname: 'term'})), llmspecinfo.label_arg], body_parsing_state_delta: __call__ (LLMParsingStateDeltaSetBlockLevel, null, __kwargtrans__ ({is_block_level: self.is_block_level}))}, kwargs)));
...
/* 000074 */ 		}) ();
/* 000079 */ 		var term_llm_ref_label_verbatim = __call__ (get_term_ref_label_verbatim, null, (function () {
/* 000079 */ 			var __accu0__ = __getitem__ (node_args, 'term');
/* 000079 */ 			return __call__ (__accu0__.get_content_nodelist, __accu0__);
/* 000079 */ 		}) ());
/* 000080 */ 		node.llmarg_term_llm_ref_label_verbatim = term_llm_ref_label_verbatim;
/* 000084 */ 		node.llmarg_labels = (function () {
/* 000084 */ 			var __accu0__ = llmspecinfo;
...
/* 000084 */ 		}) ();
/* 000090 */ 		node.llm_referenceable_infos = [(function () {
/* 000090 */ 			var __accu0__ = refs;
/* 000094 */ 			return __call__ (__accu0__.ReferenceableInfo, __accu0__, __kwargtrans__ ({formatted_ref_llm_text: node.llmarg_term_llm_ref_label_verbatim, labels: __add__ ([tuple ([self.defterm_ref_type, node.llmarg_term_llm_ref_label_verbatim])], __call__ (list, null, node.llmarg_labels))}));
/* 000094 */ 		}) ()];
/* 000099 */ 		return node;
/* 000099 */ 	});},
...
/* 000101 */ 		else {
/* 000101 */ 		}
/* 000103 */ 		var formatted_ref_llm_text = node.llmarg_term_llm_ref_label_verbatim;
...
/* 000107 */ 			}) ();
/* 000108 */ 			var __iterable0__ = node.llm_referenceable_infos;
...
/* 000119 */ 				return __call__ (__accu0__.make_fragment, __accu0__, __add__ (formatted_ref_llm_text, self.render_with_term_suffix), __kwargtrans__ ({standalone_mode: true}));
/* 000119 */ 			}) ();
...
/* 000155 */ 				var __accu1__ = __getitem__ (node.llm_referenceable_infos, 0);
/* 000155 */ 				return __call__ (__accu1__.get_target_id, __accu1__);
/* 000155 */ 			}) ()}));
/* 000155 */ 		}) ();
/* 000155 */ 	});}
/* 000155 */ });
/* 000159 */ export var RefTermMacro =  __class__ ('RefTermMacro', [LLMMacroSpecBase], {
...
/* 000166 */ 		else {
/* 000166 */ 		}
/* 000173 */ 		__call__ (__call__ (__super__, null, RefTermMacro, '__init__'), null, self, __kwargtrans__ (__mergekwargtrans__ ({macroname: macroname, arguments_spec_list: [__call__ (LLMArgumentSpec, null, '[', __kwargtrans__ ({argname: 'ref_term', llm_doc: 'The term that is being referenced.  May be omitted if it coincides with \\verba{term}'})), __call__ (LLMArgumentSpec, null, '{', __kwargtrans__ ({argname: 'term', llm_doc: 'The term the exact way it should be typeset at this point'}))]}, kwargs)));
/* 000173 */ 	});},
/* 000180 */ 	get get_llm_doc () {return __get__ (this, function (self) {
...
/* 000197 */ 		}) ())) {
/* 000199 */ 			node.llm_term_llm_show_term_nodelist = (function () {
/* 000199 */ 				var __accu0__ = __getitem__ (node_args, 'term');
/* 000199 */ 				return __call__ (__accu0__.get_content_nodelist, __accu0__);
/* 000199 */ 			}) ();
/* 000201 */ 			node.llm_term_llm_ref_label_verbatim = __call__ (get_term_ref_label_verbatim, null, (function () {
/* 000201 */ 				var __accu0__ = __getitem__ (node_args, 'ref_term');
/* 000201 */ 				return __call__ (__accu0__.get_content_nodelist, __accu0__);
/* 000201 */ 			}) ());
/* 000201 */ 		}
/* 000202 */ 		else {
/* 000203 */ 			node.llm_term_llm_show_term_nodelist = (function () {
/* 000203 */ 				var __accu0__ = __getitem__ (node_args, 'term');
/* 000203 */ 				return __call__ (__accu0__.get_content_nodelist, __accu0__);
/* 000203 */ 			}) ();
/* 000205 */ 			node.llm_term_llm_ref_label_verbatim = __call__ (get_term_ref_label_verbatim, null, node.llm_term_llm_show_term_nodelist);
/* 000205 */ 		}
/* 000207 */ 		node.llmarg_ref = tuple ([self.defterm_ref_type, node.llm_term_llm_ref_label_verbatim]);
/* 000207 */ 	});},
...
/* 000213 */ 		else {
/* 000213 */ 		}
/* 000215 */ 		var term_llm_show_term_nodelist = node.llm_term_llm_show_term_nodelist;
/* 000216 */ 		var term_llm_ref_label_verbatim = node.llm_term_llm_ref_label_verbatim;
...
/* 000220 */ 				return __call__ (__accu0__.render_nodelist, __accu0__, term_llm_show_term_nodelist, __kwargtrans__ ({render_context: render_context, is_block_level: false}));
/* 000220 */ 			}) ();
/* 000220 */ 		}
...
/* 000230 */ 			return __call__ (__accu0__.get_ref, __accu0__, self.defterm_ref_type, term_llm_ref_label_verbatim, resource_info);
/* 000230 */ 		}) ();
/* 000236 */ 		return (function () {
/* 000236 */ 			var __accu0__ = render_context.fragment_renderer;
/* 000236 */ 			return __call__ (__accu0__.render_link, __accu0__, 'term', __kwargtrans__ ({href: ref_instance.target_href, display_nodelist: term_llm_show_term_nodelist, render_context: render_context}));
/* 000236 */ 		}) ();
/* 000236 */ 	});}
/* 000236 */ });
