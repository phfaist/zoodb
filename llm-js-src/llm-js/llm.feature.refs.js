...
/* 000006 */ export {latexnodes_parsers, Feature, LLMArgumentSpec, LatexWalkerParseError, ParsedArgumentsInfo, LLMMacroSpecBase, LLMFragment};
...
/* 000055 */ 	get __init__ () {return __get__ (this, function (self, ref_type, ref_label, formatted_ref_llm_text, target_href, counter_value, counter_formatter_id) {
...
/* 000065 */ 		self._fields = tuple (['ref_type', 'ref_label', 'formatted_ref_llm_text', 'target_href', 'counter_value', 'counter_formatter_id']);
/* 000065 */ 	});},
...
/* 000127 */ 				return __call__ (__accu0__.register_reference, __accu0__, ref_type, ref_label, __kwargtrans__ ({formatted_ref_llm_text: referenceable_info.formatted_ref_llm_text, node: node, target_href: target_href}));
/* 000127 */ 			}) ();
/* 000127 */ 		}
/* 000127 */ 	});},
...
/* 000154 */ 		}) ();
/* 000156 */ 		var formatted_ref_llm_text = (function () {
/* 000156 */ 			var __accu0__ = counter;
/* 000156 */ 			return __call__ (__accu0__.format_llm, __accu0__, __kwargtrans__ ({with_prefix: counter_with_prefix, prefix_variant: counter_prefix_variant, with_delimiters: counter_with_delimiters}));
/* 000156 */ 		}) ();
...
/* 000167 */ 			return __call__ (__accu0__.register_reference, __accu0__, ref_type, ref_label, __kwargtrans__ ({node: node, formatted_ref_llm_text: formatted_ref_llm_text, target_href: target_href, counter_value: counter.value, counter_formatter_id: counter.formatter.counter_formatter_id}));
/* 000167 */ 		}) ();
/* 000167 */ 	});},
...
/* 000177 */ 						case 'formatted_ref_llm_text': var formatted_ref_llm_text = __allkwargs0__ [__attrib0__]; break;
...
/* 000199 */ 		}
/* 000203 */ 		var refinstance = __call__ (RefInstance, null, __kwargtrans__ ({ref_type: ref_type, ref_label: ref_label, formatted_ref_llm_text: formatted_ref_llm_text, target_href: target_href, counter_value: counter_value, counter_formatter_id: counter_formatter_id}));
...
/* 000251 */ 	});},
/* 000255 */ 	get render_ref () {return __get__ (this, function (self, ref_type, ref_label, display_content_llm, resource_info, render_context, counter_prefix_variant, counter_with_prefix, counter_with_delimiters) {
...
/* 000255 */ 						case 'display_content_llm': var display_content_llm = __allkwargs0__ [__attrib0__]; break;
...
/* 000262 */ 			return __call__ (__accu0__.render_ref_instance, __accu0__, ref_instance, display_content_llm, render_context, __kwargtrans__ ({counter_prefix_variant: counter_prefix_variant, counter_with_prefix: counter_with_prefix, counter_with_delimiters: counter_with_delimiters}));
/* 000262 */ 		}) ();
/* 000262 */ 	});},
/* 000269 */ 	get render_ref_instance () {return __get__ (this, function (self, ref_instance, display_content_llm, render_context, counter_prefix_variant, counter_with_prefix, counter_with_delimiters) {
...
/* 000269 */ 						case 'display_content_llm': var display_content_llm = __allkwargs0__ [__attrib0__]; break;
...
/* 000269 */ 		else {
/* 000269 */ 		}
/* 000273 */ 		if (__t__ (display_content_llm === null)) {
/* 000274 */ 			var display_content_llm = ref_instance.formatted_ref_llm_text;
/* 000274 */ 		}
/* 000276 */ 		if (__t__ (!__t__ ((__call__ (isinstance, null, display_content_llm, LLMFragment))))) {
/* 000277 */ 			var display_content_llm = (function () {
/* 000277 */ 				var __accu0__ = render_context.doc.environment;
/* 000277 */ 				return __call__ (__accu0__.make_fragment, __accu0__, display_content_llm, __kwargtrans__ ({standalone_mode: true}));
/* 000277 */ 			}) ();
/* 000277 */ 		}
/* 000282 */ 		var display_content_nodelist = display_content_llm.nodes;
...
/* 000286 */ 		}) ();
/* 000286 */ 	});},
/* 000296 */ 	ref_many_use_llm_hyperref: true,
...
/* 000326 */ 				return __call__ (__accu0__.format_many_llm, __accu0__, (function () {
...
/* 000431 */ 	});}
/* 000431 */ });
/* 000436 */ export var _ref_arg_specs = dict ({'ref_label': __call__ (LLMArgumentSpec, null, (function () {
/* 000436 */ 	var __accu0__ = latexnodes_parsers;
/* 000436 */ 	return __call__ (__accu0__.LatexCharsGroupParser, __accu0__);
/* 000439 */ }) (), __kwargtrans__ ({argname: 'ref_label'})), '[]ref_label': __call__ (LLMArgumentSpec, null, (function () {
...
/* 000444 */ }) (), __kwargtrans__ ({argname: 'ref_label'})), 'display_text': __call__ (LLMArgumentSpec, null, '{', __kwargtrans__ ({argname: 'display_text'}))});
/* 000448 */ export var RefMacro =  __class__ ('RefMacro', [LLMMacroSpecBase], {
...
/* 000466 */ 	});},
/* 000469 */ 	get _get_arguments_spec_list () {return __getcm__ (this, function (cls, command_arguments) {
...
/* 000469 */ 						case 'cls': var cls = __allkwargs0__ [__attrib0__]; break;
/* 000469 */ 						case 'command_arguments': var command_arguments = __allkwargs0__ [__attrib0__]; break;
/* 000469 */ 					}
/* 000469 */ 				}
/* 000469 */ 			}
/* 000469 */ 		}
...
/* 000470 */ 			var __iterable0__ = command_arguments;
/* 000470 */ 			for (var __index0__ = 0; __index0__ < len (__iterable0__); __index0__++) {
/* 000471 */ 				var argname = __getitem__ (__iterable0__, __index0__);
/* 000471 */ 				(function () {
/* 000471 */ 					var __accu1__ = __accu0__;
/* 000471 */ 					return __call__ (__accu1__.append, __accu1__, __getitem__ (_ref_arg_specs, argname));
/* 000471 */ 				}) ();
/* 000471 */ 			}
/* 000471 */ 			return __accu0__;
/* 000471 */ 		}) ();
/* 000471 */ 	});},
/* 000473 */ 	get postprocess_parsed_node () {return __get__ (this, function (self, node) {
...
/* 000473 */ 						case 'node': var node = __allkwargs0__ [__attrib0__]; break;
/* 000473 */ 					}
/* 000473 */ 				}
/* 000473 */ 			}
/* 000473 */ 		}
/* 000473 */ 		else {
/* 000473 */ 		}
/* 000475 */ 		var node_args = (function () {
/* 000475 */ 			var __accu0__ = __call__ (ParsedArgumentsInfo, null, __kwargtrans__ ({node: node}));
/* 000475 */ 			return __call__ (__accu0__.get_all_arguments_info, __accu0__, self.command_arguments);
/* 000475 */ 		}) ();
/* 000479 */ 		var ref_spec = (function () {
/* 000479 */ 			var __accu0__ = __getitem__ (node_args, 'ref_label');
/* 000479 */ 			return __call__ (__accu0__.get_content_as_chars, __accu0__);
/* 000479 */ 		}) ();
/* 000480 */ 		var ref_pair_list = [];
/* 000481 */ 		var __iterable0__ = (function () {
/* 000481 */ 			var __accu0__ = ref_spec;
/* 000481 */ 			return __call__ (__accu0__.py_split, __accu0__, ',');
/* 000481 */ 		}) ();
/* 000481 */ 		for (var __index0__ = 0; __index0__ < len (__iterable0__); __index0__++) {
/* 000481 */ 			var ref_spec_one = __getitem__ (__iterable0__, __index0__);
/* 000482 */ 			var __left0__ = tuple ([null, ref_spec_one]);
/* 000482 */ 			var ref_type = __left0__ [0];
/* 000482 */ 			var ref_label = __left0__ [1];
/* 000483 */ 			if (__t__ (__in__ (':', ref_label))) {
/* 000484 */ 				var __left0__ = (function () {
/* 000484 */ 					var __accu0__ = ref_label;
/* 000484 */ 					return __call__ (__accu0__.py_split, __accu0__, ':', 1);
/* 000484 */ 				}) ();
/* 000484 */ 				var ref_type = __left0__ [0];
/* 000484 */ 				var ref_label = __left0__ [1];
/* 000484 */ 			}
/* 000485 */ 			(function () {
/* 000485 */ 				var __accu0__ = ref_pair_list;
/* 000485 */ 				return __call__ (__accu0__.append, __accu0__, tuple ([ref_type, ref_label]));
/* 000485 */ 			}) ();
/* 000485 */ 		}
/* 000487 */ 		if (__t__ (__in__ ('display_text', node_args))) {
/* 000488 */ 			var display_content_nodelist = (function () {
/* 000488 */ 				var __accu0__ = __getitem__ (node_args, 'display_text');
/* 000488 */ 				return __call__ (__accu0__.get_content_nodelist, __accu0__);
/* 000488 */ 			}) ();
/* 000488 */ 		}
/* 000489 */ 		else {
/* 000490 */ 			var display_content_nodelist = null;
/* 000490 */ 		}
/* 000492 */ 		node.llmarg_ref_list = ref_pair_list;
/* 000493 */ 		if (__t__ (__eq__ (__call__ (len, null, ref_pair_list), 1))) {
/* 000494 */ 			node.llmarg_ref = __getitem__ (ref_pair_list, 0);
/* 000494 */ 		}
/* 000495 */ 		node.llm_ref_info = dict ({'ref_list': ref_pair_list, 'display_content_nodelist': display_content_nodelist});
/* 000495 */ 	});},
/* 000501 */ 	get prepare_delayed_render () {return __get__ (this, function (self, node, render_context) {
...
/* 000501 */ 						case 'node': var node = __allkwargs0__ [__attrib0__]; break;
/* 000501 */ 						case 'render_context': var render_context = __allkwargs0__ [__attrib0__]; break;
/* 000501 */ 					}
/* 000501 */ 				}
/* 000501 */ 			}
/* 000501 */ 		}
...
/* 000502 */ 		// pass;
/* 000502 */ 	});},
/* 000504 */ 	get render () {return __get__ (this, function (self, node, render_context) {
...
/* 000504 */ 		else {
/* 000504 */ 		}
/* 000506 */ 		var ref_list = __getitem__ (node.llm_ref_info, 'ref_list');
/* 000507 */ 		var display_content_nodelist = __getitem__ (node.llm_ref_info, 'display_content_nodelist');
/* 000509 */ 		var mgr = (function () {
/* 000509 */ 			var __accu0__ = render_context;
/* 000509 */ 			return __call__ (__accu0__.feature_render_manager, __accu0__, 'refs');
/* 000509 */ 		}) ();
/* 000510 */ 		var resource_info = node.latex_walker.resource_info;
/* 000512 */ 		if (__t__ (__eq__ (__call__ (len, null, ref_list), 1))) {
/* 000513 */ 			var __left0__ = __getitem__ (ref_list, 0);
/* 000513 */ 			var ref_type = __left0__ [0];
/* 000513 */ 			var ref_label = __left0__ [1];
/* 000514 */ 			try {
/* 000515 */ 				return (function () {
/* 000515 */ 					var __accu0__ = mgr;
/* 000515 */ 					return __call__ (__accu0__.render_ref, __accu0__, ref_type, ref_label, display_content_nodelist, resource_info, render_context, __kwargtrans__ ({counter_prefix_variant: self.counter_prefix_variant}));
/* 000515 */ 				}) ();
/* 000515 */ 			}
/* 000515 */ 			catch (__except0__) {
/* 000515 */ 				if (isinstance (__except0__, Exception)) {
/* 000515 */ 					var e = __except0__;
/* 000521 */ 					(function () {
/* 000521 */ 						var __accu0__ = logger;
/* 000522 */ 						return __call__ (__accu0__.error, __accu0__, 'Failed to resolve reference to ‘{}:{}’: {} in ‘{}’ @ {}'.format (ref_type, ref_label, e, (function () {
/* 000522 */ 							var __accu1__ = node;
/* 000522 */ 							return __call__ (__accu1__.latex_verbatim, __accu1__);
/* 000522 */ 						}) (), (function () {
/* 000522 */ 							var __accu1__ = node;
/* 000522 */ 							return __call__ (__accu1__.format_pos, __accu1__);
/* 000522 */ 						}) ()));
/* 000522 */ 					}) ();
/* 000523 */ 					var __except1__ = __call__ (LatexWalkerParseError, null, 'Unable to resolve reference to ‘{}:{}’: {}'.format (ref_type, ref_label, e), __kwargtrans__ ({pos: node.pos}));
/* 000523 */ 					__except1__.__cause__ = null;
/* 000523 */ 					throw __except1__;
/* 000523 */ 				}
/* 000523 */ 				else {
/* 000523 */ 					throw __except0__;
/* 000523 */ 				}
/* 000523 */ 			}
/* 000523 */ 		}
/* 000532 */ 		if (__t__ (display_content_nodelist !== null)) {
/* 000534 */ 			var __except0__ = __call__ (ValueError, null, __add__ ('Reference with custom display string cannot have multiple ref targets: ', __call__ (repr, null, ref_list)));
/* 000534 */ 			__except0__.__cause__ = null;
/* 000534 */ 			throw __except0__;
/* 000534 */ 		}
/* 000536 */ 		return (function () {
/* 000536 */ 			var __accu0__ = mgr;
/* 000536 */ 			return __call__ (__accu0__.render_ref_many, __accu0__, ref_list, resource_info, render_context);
/* 000536 */ 		}) ();
/* 000536 */ 	});}
/* 000536 */ });
/* 000541 */ export var FeatureClass = FeatureRefs;
/* 000006 */ 
