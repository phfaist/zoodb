...
/* 000010 */ export {latexnodes_parsers, Feature, LLMArgumentSpec, LLMEnvironmentSpecBase, LLMMacroSpecError, macrospec, latexnodes_nodes, LatexWalkerParseError, LatexArgumentSpec, ParsedArgumentsInfo, ParsingStateDelta};
...
/* 000606 */ 			}
/* 000610 */ 			var __except0__ = __call__ (LatexWalkerParseError, null, 'Bad cell index or merge range specification, expected ‘{}’ or ‘\\merge{}{}-RANGE{}’, got {} ({} nodes)'.format (PLACEHOLDER, '{', PLACEHOLDER, '}', __call__ (repr, null, placement_index_spec), __call__ (len, null, nl)), __kwargtrans__ ({pos: nl.pos}));
...
/* 000670 */ 			}
/* 000671 */ 			else {
/* 000676 */ 				var __except0__ = __call__ (LatexWalkerParseError, null, 'Bad cell placement specification, expected ‘ROW;COL’ or ‘COL’, got ‘{}’'.format (__call__ (_splfysidews, null, (function () {
...
/* 000716 */ 				}
/* 000721 */ 				var __except0__ = __call__ (LatexWalkerParseError, null, 'Bad cell index or range or merge range specification, expected ‘{}’ or ‘\\merge{}{}-RANGE{}’, got {} ({} nodes)'.format (PLACEHOLDER, '{', PLACEHOLDER, '}', __call__ (repr, null, placement_index_spec), __call__ (len, null, nl)), __kwargtrans__ ({pos: nl.pos}));
...
/* 000782 */ 		}
/* 000783 */ 		else {
/* 000788 */ 			var __except0__ = __call__ (LatexWalkerParseError, null, 'Expected ‘ROWS;COLS’ or ‘COLS’ or ‘’ for placement argument, got ‘{}’'.format (__call__ (_splfysidews, null, (function () {
...
/* 000799 */ 	});}
/* 000799 */ });
/* 000809 */ export var CellsEnvironment =  __class__ ('CellsEnvironment', [LLMEnvironmentSpecBase], {
...
/* 000864 */ 				continue;
/* 000864 */ 			}
/* 000869 */ 			var __except0__ = __call__ (LatexWalkerParseError, null, 'You cannot place ‘{}’ here.  Expected: \\cell, \\celldata, \\\\.'.format (__call__ (_splfysidews, null, (function () {
...
/* 000873 */ 		}) ();
/* 000875 */ 		node.llm_cells_model = cells_model;
/* 000875 */ 	});},
...
/* 000884 */ 			return __call__ (__accu0__.render_cells, __accu0__, __kwargtrans__ ({cells_model: node.llm_cells_model, render_context: render_context}));
/* 000884 */ 		}) ();
/* 000884 */ 	});}
/* 000884 */ });
...
/* 000904 */ 	});},
/* 000910 */ 	get add_llm_doc_latex_context_definitions () {return __get__ (this, function (self) {
