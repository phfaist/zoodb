...
/* 000042 */ 		}
/* 000044 */ 		var yn = node.llm_specinfo.delayed_render;
/* 000045 */ 		if (__t__ (__call__ (callable, null, yn))) {
/* 000046 */ 			var yn = __call__ (is_delayed_render, null, node, render_context);
/* 000046 */ 		}
/* 000048 */ 		__setitem__ (self._nodes_determined_as_delayed, node.node_id, yn);
/* 000049 */ 		return yn;
/* 000049 */ 	});},
...
/* 000115 */ 	});}
/* 000115 */ });
/* 000121 */ export var LLMStandaloneModeRenderContext =  __class__ ('LLMStandaloneModeRenderContext', [LLMRenderContext], {
...
/* 000125 */ 		else {
/* 000125 */ 		}
/* 000126 */ 		__call__ (__call__ (__super__, null, LLMStandaloneModeRenderContext, '__init__'), null, self, __kwargtrans__ ({fragment_renderer: fragment_renderer}));
/* 000126 */ 	});},
...
/* 000131 */ 		else {
/* 000131 */ 		}
/* 000132 */ 		var __except0__ = __call__ (ValueError, null, 'There are no document features when rendering LLM text in standalone mode (reqested ‘{}’)'.format (feature_name));
