/* 000001 */ // Transcrypt'ed from Python, 2023-04-09 22:34:25
/* 000006 */ var logging = {};
...
/* 000013 */ import {LLMStandaloneModeRenderContext} from './llm.llmrendercontext.js';
...
/* 000007 */ }) ();
/* 000019 */ export var _llmfragment_attribute_fields = tuple (['is_block_level', 'resource_info', 'standalone_mode', 'silent', 'what', 'parsing_mode']);
/* 000029 */ export var LLMFragment =  __class__ ('LLMFragment', [object], {
/* 000029 */ 	__module__: __name__,
/* 000049 */ 	get __init__ () {return __get__ (this, function (self, llm_text, environment) {
...
/* 000049 */ 		var _llm_text_if_loading_nodes = null;
...
/* 000049 */ 						case 'llm_text': var llm_text = __allkwargs0__ [__attrib0__]; break;
...
/* 000049 */ 						case '_llm_text_if_loading_nodes': var _llm_text_if_loading_nodes = __allkwargs0__ [__attrib0__]; break;
/* 000049 */ 					}
/* 000049 */ 				}
/* 000049 */ 			}
/* 000049 */ 		}
...
/* 000102 */ 						return __call__ (__accu0__.get_parse_error_message, __accu0__, e);
/* 000102 */ 					}) ();
/* 000103 */ 					(function () {
...
/* 000112 */ 		}
/* 000112 */ 	});},
/* 000115 */ 	_attribute_fields: _llmfragment_attribute_fields,
/* 000117 */ 	_fields: __call__ (tuple, null, __add__ (['nodes'], __call__ (list, null, _llmfragment_attribute_fields))),
...
/* 000146 */ 			var __except0__ = __call__ (ValueError, null, 'You can only use render_standalone() on a fragment that was parsed in standalone mode (use `standalone_mode=True` in the LLMFragment constructor)');
/* 000146 */ 			__except0__.__cause__ = null;
/* 000146 */ 			throw __except0__;
/* 000146 */ 		}
/* 000151 */ 		var render_context = __call__ (LLMStandaloneModeRenderContext, null, __kwargtrans__ ({fragment_renderer: fragment_renderer}));
/* 000152 */ 		return (function () {
/* 000152 */ 			var __accu0__ = self;
/* 000152 */ 			return __call__ (__accu0__.render, __accu0__, render_context);
/* 000152 */ 		}) ();
/* 000152 */ 	});},
/* 000155 */ 	get parse () {return __getcm__ (this, function (cls, llm_text, environment) {
...
/* 000155 */ 						case 'llm_text': var llm_text = __allkwargs0__ [__attrib0__]; break;
...
/* 000166 */ 			return __call__ (__accu0__.make_latex_walker, __accu0__, llm_text, __kwargtrans__ ({is_block_level: is_block_level, parsing_mode: parsing_mode, resource_info: resource_info, standalone_mode: standalone_mode, tolerant_parsing: tolerant_parsing, what: what, input_lineno_colno_offsets: input_lineno_colno_offsets}));
/* 000166 */ 		}) ();
...
/* 000189 */ 			var __accu0__ = self.llm_text;
...
/* 000194 */ 		else {
/* 000194 */ 		}
/* 000195 */ 		var thellmtext = self.llm_text;
/* 000196 */ 		if (__t__ (__gt__ (__call__ (len, null, thellmtext), 50))) {
/* 000197 */ 			var thellmtext = __add__ (__getslice__ (thellmtext, 0, 49, 1), '…');
/* 000197 */ 		}
/* 000198 */ 		return '<{} {}>'.format (self.__class__.__name__, thellmtext);
/* 000198 */ 	});},
...
/* 000203 */ 				var __accu1__ = self.llm_text;
...
/* 000239 */ 			return __call__ (__accu0__.make_fragment, __accu0__, __kwargtrans__ (__mergekwargtrans__ ({llm_text: thenodes}, (function () {
...
/* 000251 */ 			return __call__ (__accu0__.make_fragment, __accu0__, __kwargtrans__ (__mergekwargtrans__ ({llm_text: newnodes}, (function () {
...
/* 000328 */ 		else {
/* 000328 */ 		}
/* 000331 */ 		if (__t__ (__call__ (hasattr, null, node.spec, '_llm_main_text_argument'))) {
/* 000332 */ 			var main_text_argname = node.spec._llm_main_text_argument;
