...
let _rx_llm_escape_chars = new RegExp(
    '[' + Object.keys(llm_escape_chars).map((c)=>_recharclassescape(c)).join('') + ']',
    'g'
);
function escape_llm(x)
{
    _rx_llm_escape_chars.lastIndex = 0;
    return x.replaceAll(_rx_llm_escape_chars, (m) => llm_escape_chars[m]);
};
            ...
            try {
                zoollmenviron.make_fragment(
                    ...
                    $$kw({
                        ...
                        // -- nodes into valid strict LLM text
