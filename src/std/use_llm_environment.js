...
const debug = debug_mod("zoodb.std.use_llm_environment");
...
{
    const zoo_llm_environment_options = loMerge(
        { },
        _this.config.zoo_llm_environment_options ?? {}
    );

    const zoo_llm_environment = new ZooLLMEnvironment(zoo_llm_environment_options);
